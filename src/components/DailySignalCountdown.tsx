    ...
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row", justifyContent: isMobile ? "center" : "space-between", alignItems: "center", flexWrap: "wrap", gap: 6 }}>
        ...
        <div style={{ textAlign: isMobile ? "center" : "right" }}>
          {sendTime && (
            <p style={{ color: "#52525b", fontSize: "0.7rem", margin: "0 0 2px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: isMobile ? "center" : "flex-start", gap: 2 }}>
        {[h, m, s].map((unit, i) => (
          <span key={i} style={{ display: "flex", alignItems: "center", gap: 2 }}>
            <span style={{
              fontFamily: "monospace", fontSize: isMobile ? "1.6rem" : "1.75rem", fontWeight: 800,
            ...
            {i < 2 && (
              <span style={{ color: "#52525b", fontSize: "1.35rem", fontWeight: 700, marginBottom: 2 }}>:</span>
            )}
          </span>
        ))}
      </div>
