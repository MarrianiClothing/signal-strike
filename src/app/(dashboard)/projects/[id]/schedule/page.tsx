...
export default function ProjectDetailPage() {
  ...
  return (
    <div style={{ padding: isMobile ? 16 : 32, maxWidth: 1200 }}>
      ...
      {/* Schedule header */}
      <h2 style={{fontSize:"1.1rem",fontWeight:800,color:"#fafafa",marginBottom:20,fontFamily:"var(--font-cinzel,serif)",letterSpacing:"0.06em",textTransform:"uppercase"}}>Project Schedule</h2>
